...
<body>
  ...
  <div class="ui vertical footer segment form-page pull-right">
    <div class="ui container" style="text-align:center;">
      <span>Looking to track your account? Check out our friends at <a href="http://runecheck.com/">RuneCheck</a></span>
    </div>
  </div>
</body>
</html>
